...
export default function Navbar() {
  const { searchParam, setSearchParam, handleSubmit, favoriteList } = useContext(GlobalContext);
    ...
    <>
      <div className="header"
        style={{
          height: "40vw",
          margin: "30px auto",
          background: 'url("https://www.ppa.com/assets/images/ppmag_articles/2019320160929_ftinc_286_2.jpg")',
      ...
      <nav className="bg-white bg-opacity-50 shadow-lg fixed top-0 left-0 w-full z-50">
